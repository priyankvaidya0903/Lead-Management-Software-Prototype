export async function sendWhatsAppMessage(to: string, messageBody: any) {
...
export async function sendWhatsAppInteractiveList(to: string, header: string, body: string, buttonText: string, sections: {title: string, rows: {id: string, title: string, description?: string}[]}[]) {
  return sendWhatsAppMessage(to, {
    type: "interactive",
    interactive: {
      type: "list",
...
export async function sendWhatsAppInteractiveButtons(to: string, bodyText: string, buttons: {id: string, title: string}[]) {
  return sendWhatsAppMessage(to, {
    type: "interactive",
    interactive: {
      type: "button",
