...
import { findLeadByPhone, createLeadNote, createEscalationTask, updateLeadStage, updateLeadFields, getClinicsList, getManagersForClinic } from "../../lib/twentyCrmClient.js";
import { getNextManagerIndex } from "../../lib/roundRobin.js";
import { sendWhatsAppText, sendWhatsAppInteractiveList } from "../../lib/whatsapp.js";
const router = Router();
...
router.post("/", async (req, res) => {
    try {
        const headerPhone = req.headers["phone"];
        const headerStage = (req.headers["status"] || req.headers["stage"]);
