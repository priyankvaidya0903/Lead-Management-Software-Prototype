...
cat <<EOF > "$DEPLOY_DIR/api-service/.env"
# ── Twenty CRM REST API ──
TWENTY_API_URL=http://server:3000/rest
TWENTY_API_KEY=eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IjY4ZTUyNDZiLTkyZjMtNGQ3My04ZDA2LThhZGJhMzg3ZjBhYyJ9..QgE8oNyS4IoQt5EEkf7GD1js2JGCbOsvmm67lX0xz8Pubtl0gQ4mDvS4jMVVguNT0YtcFC1QGbAcIF6JBoi06A

# ── Webhook URLs ──
TWENTY_WORKFLOW_WEBHOOK_URL=http://server:3000/webhooks/workflows/eec504f4-f6e4-4c9d-816e-7dd50223e72e/6a79f8ab-05cf-4e82-a833-b9fa5394f3e7

# ── Managers Object Configuration ──
TWENTY_MANAGERS_OBJECT=managerss
TWENTY_MANAGERS_CLINIC_FIELD=clinicsId

# ── Redis ──
REDIS_URL=redis://redis:6379

# ── Meta WhatsApp ──
META_WHATSAPP_ACCESS_TOKEN=
META_WHATSAPP_PHONE_NUMBER_ID=1019698667902138
META_WHATSAPP_VERIFY_TOKEN=my_super_secret_token_123
